package com.alaythiaproductions.justeatit;
...
import com.alaythiaproductions.justeatit.remote.ICloudFunctions;
import com.alaythiaproductions.justeatit.remote.RetrofitICloudClient;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void showRegisterDialog(final FirebaseUser user) {
        ...
        final EditText editName = itemView.findViewById(R.id.edit_name);
        final EditText editAddress = itemView.findViewById(R.id.edit_address);
        final EditText editPhone = itemView.findViewById(R.id.edit_phone);
        ...
        builder.setPositiveButton("REGISTER", new DialogInterface.OnClickListener() {
            ...
            public void onClick(final DialogInterface dialog, int which) {
                ...
                userModel.setAddress(editAddress.getText().toString().trim());
                userModel.setPhone(editPhone.getText().toString().trim());
